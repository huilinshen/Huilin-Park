...
export const projects = [
  ...
  {
    id: "project-03",
    slug: "third-case-study",
    title: "Third Case Study",
    label: "Project 03",
    type: "project",
    href: "/projects/third-case-study",
    color: "#87b8ff",
    accent: "#2c65b5",
    position: [2.1, 0, 0.2],
    year: "2026",
    role: "Product Design",
    cover: "/projects/third-case-study/cover.jpg",
    tags: ["UIUX", "Prototype", "Storytelling"],
    summary: "Reserve this last MVP booth for the third project you want to complete this week.",
    sections: [
      { title: "Problem", body: "Replace with the user problem, product context, and audience." },
      { title: "Process", body: "Replace with research, flows, wireframes, prototype decisions, and Figma exports." },
      { title: "Outcome", body: "Replace with the final experience, design value, and reflection." },
    ],
  },
